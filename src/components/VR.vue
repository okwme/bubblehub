  ...
  <div id="vr">
    <a-scene id="scene" ref="scene">
      ...
      <!--<a-assets>-->
        ...
        <!--<img id="starrysky" src="../assets/starrysky.jpg">-->
      <!--</a-assets>-->
